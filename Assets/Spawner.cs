...
public class Spawner : MonoBehaviour
{
    ...
    float timeToNextSpawn;     //Tracks how long we should waut before spawning a new object
    ...
    void Update()
    {
        //Add Time.deltaTime returns to the amount of time passed since the last frame.
        ...
        {
            //Use 
            //Use Random.Range to pick a number between 0 amd the amount of items we have on our object list
            ...
            //After spawning, we slwct a new random time for the next spawn and set our timer back to zero
            timeToNextSpawn = Random.Range(minSpawnTime, maxSpawnTime);
